  ...
  <TooltipComponent content ={title} position="BottomCenter">
    ...
    >
      <span 
        ...
        className="absolute inline-flex rouned-full h-2 w-2 right-2 top-2"
      />
        {icon}
...
const Navbar = () => {
  ...
  //we are tracking the width of our window
  useEffect(() =>{
...
//whenever screensize changes to this above effect
